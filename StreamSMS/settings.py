...
AUTHENTICATION_BACKENDS = [
    'apps.broadcast_manager.backends.RoleBasedAuthBackend',
...
MIDDLEWARE = [
    ...
    'apps.broadcast_manager.middleware.ActivityTrackingMiddleware',
]
...
WSGI_APPLICATION = 'StreamSMS.wsgi.application'
